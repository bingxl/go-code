...
func newTodo(db *gorm.DB, opts ...gen.DOOption) todo {
	...
	_todo.Tag = field.NewString(tableName, "tag")
	_todo.Status = field.NewInt32(tableName, "status")
	...
	_todo.Owner = field.NewInt32(tableName, "owner")
...
type todo struct {
	...
	Tag       field.String
	Status    field.Int32 // 待办事项状态: 0 未办, 1 已完成
